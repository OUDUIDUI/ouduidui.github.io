...
date: 2021-07-27 18:27:18
tags: [github-actions,ci,npm]
...
> 关于github actions的学习，可以去看看[官方文档](https://docs.github.com/cn/actions)
...
![WeChatdb6470d685993f4bb43d203021519421.png](/images/publish_npm_by_github_actions/1.png)

然后点击`Generate New Token`创建一个新的`Token`。
![WeChat3da491aff53c856dad95c4cf5a2b0d65.png](/images/publish_npm_by_github_actions/2.png)

然后选择`Automation`，确定创建`Token`。

![WeChat565126ef4c337c96594badfcfe868857.png](/images/publish_npm_by_github_actions/3.png)

然后来到你的`Github`，选择你的项目，点击`Settings`，然后选择`Secrets`，点击`New repository secret`。

![WeChat5a182589fc211e0089597980455670b8.png](/images/publish_npm_by_github_actions/4.png)

输入名称和`Tokens`，然后点击保存。

![截屏2021-07-27 17.07.18.png](/images/publish_npm_by_github_actions/5.png)
...
![截屏2021-07-27 17.39.24.png](/images/publish_npm_by_github_actions/6.png)

在编辑之前，我先简单说明一下我的项目结构。

我的项目打包文件都放在`dist`路径下，在里面除了打包文件之外，还包含`package.json`和`README.md`，这两个文件是上传到`npm`必需的。

![截屏2021-07-27 17.49.41.png](/images/publish_npm_by_github_actions/7.png)
...
![截屏2021-07-27 18.13.04.png](/images/publish_npm_by_github_actions/8.png)

同时你可以点进去，进一步查看执行情况，如果报错了你也能准确定位到哪里出问题了。

![截屏2021-07-27 18.14.53.png](/images/publish_npm_by_github_actions/9.png)
